...
import LiquidationCurveGraph from "./LiquidationCurveGraph.js";

function LiquidationCurveCard(props) {
        ...
        tabs={[
          {
            ...
            content: <LiquidationCurveGraph drop={drop} ilk={ilk} />,
          },
          {
            id: "bar",
            title: <FontAwesomeIcon icon={faChartBar} />,
            content: <LiquidationCurveBarChart drop={drop} ilk={ilk} />,
          },
        ]}
      />
    </>
...
export default withErrorBoundary(LiquidationCurveCard);
